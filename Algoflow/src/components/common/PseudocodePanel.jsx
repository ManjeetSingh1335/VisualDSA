  ...
  return (
    <div className="w-full flex flex-col gap-4 bg-slate-900/40 p-5 rounded-2xl border border-white/5 backdrop-blur-md">
      ...
      <div className="flex items-center gap-2 pb-2 border-b border-white/5">
        ...
        <h3 className="text-sm font-semibold tracking-wider uppercase text-slate-300">Pseudocode</h3>
      </div>
      {/* Code Area */}
      <div className="bg-[#030712] rounded-xl border border-white/5 p-4 overflow-x-auto font-mono text-xs leading-relaxed text-slate-300 select-none">
          ...
          return (
            <div
              ...
              className={`flex items-center gap-4 px-2 py-1 rounded transition-colors duration-150 ${
                isActive
                  ? 'bg-brand-primary/20 border-l-2 border-brand-primary text-white font-semibold'
